    ...
    <div id="MainLayout" class="w-full fixed z-50">
        <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
            <ul class="
                ...
                <li @mouseenter="isAccountMenu = true" @mouseleave="isAccountMenu = false"
                    ...
                    :class="isAccountMenu ? 'bg-white border z-40 shadow-[0_15px_20px_20px_rgba(0,0,0,0.1)]' : 'border border-[#FAFAFA]'">
                    <Icon name="ph:user-thin" size="17" />
                    Account
                    <Icon name="mdi:chevron-down" size="15" class="ml-5" />

                    <div id="AccountMenu" v-if="isAccountMenu"
                        class="absolute bg-white w-[220px] text-[#333333] z-40 top-[38px] -left-[100px] border-x border-b shadow-md">
                        <div v-if="!user">
                            <div class="flex items-center justify-center gap-1 px-3 mb-3 mt-3">
                                <NuxtLink to="/auth"
                                    class="bg-[#FF4646] hover:bg-[#ea5050] text-center w-2/3 text-[12px] rounded-md text-white font-semibold p-2">
                                    Login / Register
                                </NuxtLink>
                            </div>
                        </div>
        ...
        <div id="MainHeader" class="flex items-center w-full bg-white">
            <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
                ...
                <div class="max-w-[700px] w-full md:block hidden self-center">
                    <div class="relative">
                        <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full">
                            <input class="
                                    ...
                                    pl-3
                                    focus:outline-none
                                " placeholder="cat food" type="text" v-model="searchItem">
