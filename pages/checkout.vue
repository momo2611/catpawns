            ...
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                ...
                <div class="md:w-[35%]">
                    ...
                    <div class="bg-white rounded-lg p-4 mt-4">
                        <div class="text-lg font-semibold mb-2 mt-2">Catpawns</div>
                        <p class="my-2">
                            For test environment, the card number is: 4242 4242 4242 4242
                        </p>
                        <p class="my-2">
                            Catpawns keeps your information and payment safe
                        </p>
